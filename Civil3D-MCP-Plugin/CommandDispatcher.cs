...
public static class CommandDispatcher
{
  ...
  return method switch
  {
      ...
      "listEntities" => EntityCommands.ListEntitiesAsync(parameters),
      "selectEntities" => EntityCommands.SelectEntitiesAsync(parameters),
      ...
      "surfaceCreateEx" => SurfaceExtraCommands.CreateAsync(parameters),
      "surfaceCreateFromSource" => SurfaceExtraCommands.CreateFromSourceAsync(parameters),
      "surfaceAddData" => SurfaceExtraCommands.AddDataAsync(parameters),
      "surfaceDefinition" => SurfaceExtraCommands.OperationsAsync(parameters),
      "surfaceEdit" => SurfaceExtraCommands.EditAsync(parameters),
      "surfaceManage" => SurfaceExtraCommands.ManageAsync(parameters),
      "surfaceExtract" => SurfaceExtraCommands.ExtractAsync(parameters),
      "surfaceBoundedVolume" => SurfaceExtraCommands.BoundedVolumeAsync(parameters),
      "surfaceExportDem" => SurfaceExtraCommands.ExportDemAsync(parameters),
      "surfaceMask" => SurfaceExtraCommands.MaskAsync(parameters),
      "surfaceAnalysisSet" => SurfaceExtraCommands.AnalysisSetAsync(parameters),
      "surfacePointFileFormats" => SurfaceExtraCommands.PointFileFormatsAsync(parameters),
      ...
      "createSectionViewAtStation" => SectionCommands.CreateSectionViewAtStationAsync(parameters),
      ...
      "getCorridorSection" => CorridorEditingCommands.GetCorridorSectionAsync(parameters),
      "listCorridorFeatureLineCodes" => CorridorEditingCommands.ListCorridorFeatureLineCodesAsync(parameters),
      "exportCorridorFeatureLine" => CorridorEditingCommands.ExportCorridorFeatureLineAsync(parameters),
      "corridorSurfaceInfo" => CorridorSurfaceCommands.InfoAsync(parameters),
      "corridorSurfaceCreate" => CorridorSurfaceCommands.CreateAsync(parameters),
      "corridorSurfaceEdit" => CorridorSurfaceCommands.EditAsync(parameters),
      "corridorSurfaceDelete" => CorridorSurfaceCommands.DeleteAsync(parameters),
      "corridorExportSolids" => CorridorSurfaceCommands.ExportSolidsAsync(parameters),
      "addCorridorRegion" => CorridorEditingCommands.AddCorridorRegionAsync(parameters),
      "setCorridorRegionFrequency" => CorridorEditingCommands.SetCorridorRegionFrequencyAsync(parameters),
      "deleteCorridorRegion" => CorridorEditingCommands.DeleteCorridorRegionAsync(parameters),
      "predictCorridorBowties" => CorridorBowtieCommands.PredictCorridorBowtiesAsync(parameters),
      "splitCorridorRegion" => CorridorBowtieCommands.SplitCorridorRegionAsync(parameters),
      ...
      "bowtieSeam" => CorridorBowtieCommands.BowtieSeamAsync(parameters),
      ...
      "editPipeNetwork" => PipeNetworkCommands.EditPipeNetworkAsync(parameters),
      "deletePipeNetwork" => PipeNetworkCommands.DeletePipeNetworkAsync(parameters),
      "getPipeNetworkPath" => PipeNetworkCommands.GetPipeNetworkPathAsync(parameters),
      ...
      // Alignment editing
      "alignmentOffsetInfo" => AlignmentEditCommands.OffsetInfoAsync(parameters),
      "alignmentCreateLayout" => AlignmentLayoutCommands.CreateLayoutAsync(parameters),
      "alignmentEntityAdd" => AlignmentLayoutCommands.EntityAddAsync(parameters),
      "alignmentEntityDelete" => AlignmentLayoutCommands.EntityDeleteAsync(parameters),
      "alignmentCreateConnected" => AlignmentLayoutCommands.CreateConnectedAsync(parameters),
      "featureLineCreateFromObject" => FeatureLineCommands.CreateFromObjectAsync(parameters),
      "featureLineCreateFromLayer" => FeatureLineCommands.CreateFromLayerAsync(parameters),
      "featureLineElevationsFromCogo" => FeatureLineCommands.ElevationsFromCogoAsync(parameters),
      "featureLineCreateFromPoints" => FeatureLineCommands.CreateFromPointsAsync(parameters),
      "featureLinePoints" => FeatureLineCommands.PointsAsync(parameters),
      "featureLineEdit" => FeatureLineCommands.EditAsync(parameters),
      "profileCreateFromFile" => ProfileExtraCommands.CreateFromFileAsync(parameters),
      "profileCopy" => ProfileExtraCommands.CopyAsync(parameters),
      "profileViewCreateMultiple" => ProfileExtraCommands.ViewCreateMultipleAsync(parameters),
      "profileCreateFromSurfaceEx" => ProfileExtraCommands.CreateFromSurfaceAsync(parameters),
      ...
      "profileMovePvi" => ProfileEditCommands.MovePviAsync(parameters),
      ...
      "listLayouts" => PlanProductionCommands.ListLayoutsAsync(parameters),
      "createLayout" => PlanProductionCommands.CreateLayoutAsync(parameters),
    ...
    "createAssembly" => AssemblyCreationCommands.CreateAssemblyAsync(parameters),
      ...
      // Styles (civil3d_style)
      "listStyles" => StyleCommands.ListStylesAsync(parameters),
      "getStyle" => StyleCommands.GetStyleAsync(parameters),
      "createStyle" => StyleCommands.CreateStyleAsync(parameters),
      "editStyle" => StyleCommands.EditStyleAsync(parameters),
      "copyStyle" => StyleCommands.CopyStyleAsync(parameters),
      "deleteStyle" => StyleCommands.DeleteStyleAsync(parameters),
      "applyStyle" => StyleCommands.ApplyStyleAsync(parameters),
      "applyStyleLibrary" => StyleCommands.ApplyStyleLibraryAsync(parameters),
      "exportStyles" => StyleCommands.ExportStylesAsync(parameters),
      "styleAbbreviations" => LabelStyleCommands.AbbreviationsAsync(parameters),
      "placeLabels" => LabelStyleCommands.PlaceLabelsAsync(parameters),
